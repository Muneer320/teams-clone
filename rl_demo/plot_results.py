...
def plot_episode_rewards(episodes, save_path=None):
    ...
    plt.title('Agent Performance: Episode Rewards',
...
def plot_reward_distribution(episodes, save_path=None):
    ...
    plt.axvline(median_reward, color='b', linestyle='--',
...
def main():
    ...
    plot_action_distribution(
        episodes, f"{args.output_dir}/actions.{args.format}")
    plot_reward_distribution(
        episodes, f"{args.output_dir}/reward_dist.{args.format}")
    plot_task_performance(
        episodes, f"{args.output_dir}/task_performance.{args.format}")
